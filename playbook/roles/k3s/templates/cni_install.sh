...
POD_CIDR="{{ pod_cidr }}"                # Do NOT overlap with NODE/SVC/JOIN CIDR
POD_GATEWAY="{{ pod_gateway }}"
SVC_CIDR="{{ svc_cidr }}"                # Do NOT overlap with NODE/POD/JOIN CIDR
JOIN_CIDR="{{ join_cidr }}"              # Do NOT overlap with NODE/POD/SVC CIDR
